    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=30, validators=[django.core.validators.MinLengthValidator(2), PeopleSite.accounts.models.is_alphabetical])),
                ('last_name', models.CharField(max_length=30, validators=[django.core.validators.MinLengthValidator(2), PeopleSite.accounts.models.is_alphabetical])),
